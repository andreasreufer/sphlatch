...
int main(int argc, char* argv[])
{
  ...
  ///
  /// scale position and unit volume set smoothing length
  ///

  const valueType rScale = 6.348e8;
  const valueType vScale = rScale*rScale*rScale;
