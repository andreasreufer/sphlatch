...
int main(int argc, char* argv[])
{
   ...
   const fType mTot      = 0.144*5.3014e27;
   const fType mCoreFrac = 0.0;
   const iType matCore   = 5;
   const iType matMantle = 2;
   const fType rhoCore   = 6.;
   const fType rhoMantle = 0.95;
   const fType TInitCore = 0.1;
   const fType TInitMant = 0.01;
